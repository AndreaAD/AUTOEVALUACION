...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Agregar Actividad", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    $objComponentes->form($datos);
        ...
        $datos = array(
                    ...
                    "onchange"=>"FiltrarDato('../Controlador/SAD_Agregar_Actividad_Controlador.php', 'fk_sub_grupo');"
                    );
        ...
        $objComponentes->iconos($datos, $filtro);
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosActividad('../Controlador/SAD_Agregar_Actividad_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
