...
class AddEscalaView
{
    // se establece un objeto a la clase elementos vista
    function elementos()
    {
    ...
    //se muestra la interface para guardar una escala
    function guardar()
    {
        global $objComponentes;
        $this->elementos(); 
        ...
        $datos=array(
                    ...
                    "value"=>"",//(no necesario) El atributo value especifica el valor de un elemento
        ...
        $datos = array(
                    ...
                    "onclick"=>"guardar();"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
