...
$datos = array(
            ...
            "onclick"=>"enc_regresar('ENC_seleccionEncuestaInstitucional_controlador.php');"// (necesario) funcion js que se ejecutara si se hace click en el boton
            );    
...
<table id="tabla-preguntas">
    ...
    <th style="width: auto; min-height: 130px; height:130px;">Texto Pregunta</th>
    <?php
...
$objComp->input_checkbox_sql($arrayDatosGrupos,$datos);
...
$datos = array(
    ...
    "onclick"=>"enc_guardarPregunta('guardar','institucional')"// (necesario) funcion js que se ejecutara si se hace click en el boton
    );
