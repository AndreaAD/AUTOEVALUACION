...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar M&oacute;dulo", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosModulo('../Controlador/SAD_Modificar_Modulo_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
