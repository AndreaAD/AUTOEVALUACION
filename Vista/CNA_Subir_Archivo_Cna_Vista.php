...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Subir Factor, Caracter&iacute;stica, Aspecto, Evidencia", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    $objComponentes->form($datos);
        ...
        $datos = array(
                    ...
                    "label"=>"Agregar Factor, Caracter&iacute;stica, Aspecto, Evidencia",//(necesrio - si se omite queda como si se pasara vacio) La etiqueta label define una etiqueta para un elemento
        ...
        $datos = array(
                    ...
                    "onclick"=>"EnviarFile('../Controlador/CNA_Subir_Archivo_Cna_Controlador.php');"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
