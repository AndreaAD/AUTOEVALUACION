...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar Aspecto", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        ///////////////////////////input hidden//////////////////////////////
        $datos=array(
                    "id"=>"pk_aspecto", //(no necesario) define el id que tendra el campo
                    "name"=>"pk_aspecto", // (necesario) define el name que tendra el campo
                    "value"=>$sqlRol->fields['pk_aspecto']
        ...
        "placeholder"=>"Seleccione una caracter&oicute;stica",//(no necesario) El atributo placeholder especifica una pista corta que describe el valor esperado de un campo de entrada
        ...
        $datos=array(
                    ...
                    "help"=>"Por favor digite suel nombre",//(no necesario) Es cuando se quiere colocar un testo de ayuda para le usuario que esta llenando el campo
        ...
        $datos = array(
                    ...
                    "value"=>"Modifcar",//(necesario) valor que mostrar el boton
                    "onclick"=>"ValidacionCaracteristica('../Controlador/CNA_Modificar_Aspecto_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
