        ...
        <li><div class="titulo_circulo">Tablero de Ponderacion</div><br>
            <div class="ch-item">				
                <div class="ch-info">
                    ...
                    <div class="ch-info-back">
                        <h3>Tablero</h3>
                        <p>Fuentes Secundarias<a>Ver</a></p>
                    </div>	
                </div>
            </div>
        </li>
        <li><div class="titulo_circulo">Grafico de Ponderacion</div><br>
            <div class="ch-item">
                <div class="ch-info">
        ...
        <li><div class="titulo_circulo">Tablero de Resultados</div><br>
            <div class="ch-item">				
                <div class="ch-info">
                    ...
                    <div class="ch-info-back">
                        <h3>Factores</h3>
                        <p>Resultados <a onclick="Entrar('../Controlador/PLM_PrincipalAnalisisFactor_Control.php?opcion=principal');">Ver</a></p>
                    </div>	
                </div>
            </div>
        </li>
        <li><div class="titulo_circulo">Grafica PLM</div><br>
            <div class="ch-item">
                <div class="ch-info">
                    ...
                    <div class="ch-info-back">
                        <h3>Mejoramiento</h3>
                        <p>Resultados<a onclick="Entrar('../Controlador/PLM_PrincipalAnalisis_Control.php?H_opcion=verGraficaFac&opc=2');">Ver</a></p>
                    </div>
                </div>
            </div>
        </li>
