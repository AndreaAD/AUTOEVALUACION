...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        $datos=array(
                    ...
                    "help"=>"Por favor digite su nombre",//(no necesario) Es cuando se quiere colocar un testo de ayuda para le usuario que esta llenando el campo
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosGrupo('../Controlador/SAD_Modificar_Grupo_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
