...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar Evidencia", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidacionCaracteristica('../Controlador/CNA_Modificar_Evidencia_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
