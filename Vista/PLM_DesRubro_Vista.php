...
class EliRubroView
{
    //muestra los rubros habilitados, para deshabilitarlos
        ...
        <form id="buscar" name="buscar" method="post" >
            ...
            <div class="bloque una-columna-centro-medio">
              <div class="titulo-bloque texto-izquierda">
                  <h2 class="icon-quill">Deshabilitar Rubro del P.O.A.I</h2>
              </div>
              <br />
              <?php
              if($rubros[0][0])
              ...
              {
                ?>
                <h3>No hay Rubros Habilitados!!!</h3>
                <?php
              }
              ?>
            </div>
    ...
    //muestra un rubro en especifico para deshabilitarlo
