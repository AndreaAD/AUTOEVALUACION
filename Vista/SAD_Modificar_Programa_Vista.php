...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar Programa", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        ///////////////////////////input hidden//////////////////////////////
        $datos=array(
                    "id"=>"pk_programa", //(no necesario) define el id que tendra el campo
                    "name"=>"pk_programa", // (necesario) define el name que tendra el campo
                    "value"=>$sqlRol->fields['pk_programa']
        ...
        $datos = array(
                    ...
                    "selected"=>$sqlRol->fields['fk_sede']
                    );
        ...
        $datos = array(
                    ...
                    "selected"=>$sqlRol->fields['fk_facultad']
                    );
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosRTO('../Controlador/SAD_Modificar_Programa_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
