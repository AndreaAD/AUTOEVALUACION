...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Agregar Grupo Inter&eacute;s", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    $objComponentes->form($datos);
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosRTO('../Controlador/CNA_Agregar_Grupo_Interes_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
