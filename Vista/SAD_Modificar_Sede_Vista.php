...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar Sede", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        ///////////////////////////input hidden//////////////////////////////
        $datos=array(
                    "id"=>"pk_sede", //(no necesario) define el id que tendra el campo
                    "name"=>"pk_sede", // (necesario) define el name que tendra el campo
                    "value"=>$sqlRol->fields['pk_sede']
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosRTO('../Controlador/SAD_Modificar_Sede_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
