...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Ver Proceso", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$resSqlActividades->EOF) {
        ...
        $datos=array(
                    ...
                    "maxlength"=>"40",//(no necesario) El atributo maxlength especifica el número máximo de caracteres permitidos en el elemento
        ...
        $datos=array(
                    ...
                    "help"=>"Por favor digite una descripcion",//(no necesario) Es cuando se quiere colocar un testo de ayuda para le usuario que esta llenando el campo
