...
$datos=array("id"=>"ventana-caracteristicas",// (necesario) id de la ventana
            "titulo"=>"Lista de Caracteristicas", //(no necesario) titulo que tendra la ventana
...
if($rsDatos!= null){
?>
<p class="titulo-ventana">SELECCIONE UNA CARACTERISTICA</p>
<?php
...
while(!$rsDatos->EOF)
{
    ...
    <li class="lista-seleccionar" >
        ...
        <p id="texto" style="border:0px; margin: 0px; padding:0px;" onclick="enc_seleccionarTabla(this,'ENC_listaCaracteristicas_controlador.php','caracteristica','#ventana-caracteristicas');"> <?php echo $rsDatos->fields[2].' '.(ucfirst(strtolower($rsDatos->fields[1])));?>
        </p> 
    </li>
    <?php
...
<?php
    ...
    ?>
    <p>Seleccione primero un factor.</p>
    <?php
}
