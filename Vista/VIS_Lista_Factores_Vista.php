...
while(!$rsDatos->EOF)
{
    ...
    <li class="lista-seleccionar" >
        ...
        <p id="texto" style="border:0px; margin: 0px; padding:0px;" onclick="sad_seleccionarTabla(this,'VIS_Lista_Factores_Controlador.php','factor','#ventana-factores');"> <?php echo (ucfirst(strtolower($rsDatos->fields[1])));?>
        </p> 
    </li>
    <?php
