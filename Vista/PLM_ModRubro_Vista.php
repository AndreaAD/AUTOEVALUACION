...
class ModRubroView
{
    //se muestran todos los rubros habilitados 
        ...
        <form id="buscar" name="buscar" method="post" >
            ...
            <div class="bloque una-columna-centro-medio">
              <div class="titulo-bloque texto-izquierda">
                  <h2 class="icon-quill">Modificar Rubro del P.O.A.I</h2>
              </div>
              <br />
              <?php
              if($rubros[0][0])
              ...
              {
              ?>
                <h3>No hay rubros habilitados para Modificar!</h3>
              <?php
              }
              ?>
            </div>
        ...
        <table border="0" align="center"> 
            ...
            ?>
             ...
             <tr>
                ...
                <td>
                    <input type="text" id="T_nombre" name="T_nombre" value="<?php echo utf8_encode($arrRubro[0][1]);?>"  size="30" />
                </td>
             </tr>
             <tr>
                <td>
