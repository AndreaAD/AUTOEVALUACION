...
if($institucional==0){
    $datos = array(
        ...
        "onclick"=>"enc_aceptarCrearPregunta(this,'../Controlador/ENC_crearPreguntas_controlador.php');"// (necesario) funcion js que se ejecutara si se hace click en el boton
        );
}else{
    $datos = array(
        "class"=>"mediano",//(necesario) tamaño del boton puede ser {grande,mediano,small}
