...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar Tipo Usuario", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        ///////////////////////////input hidden//////////////////////////////
        $datos=array(
                    "id"=>"pk_tipo_usuario", //(no necesario) define el id que tendra el campo
                    "name"=>"pk_tipo_usuario", // (necesario) define el name que tendra el campo
                    "value"=>$sqlRol->fields['pk_tipo_usuario']
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosRTO('../Controlador/SAD_Modificar_Tipo_Usuario_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
