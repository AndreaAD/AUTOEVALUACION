...
$datos = array(
        ...
        "onclick"=>"enc_guardarPregunta('modificar');"// (necesario) funcion js que se ejecutara si se hace click en el boton
        );
...
$datos = array(
        ...
        "icono"=>"none", //(necesario) icono que aparecera en el boton, si se desea sin icono poner {none}
        "onclick"=>"enc_cancelarModificar();"// (necesario) funcion js que se ejecutara si se hace click en el boton
        );
$objComp->button_normal($datos);
