...
class SelProyectoView
{
    
    // se buscan todos los proyectos deshabilitados
    public function buscaProyecto($proyectos)
    {
        ?>
        <br />
        <br />
        <form id="buscar" name="buscar" method="post" >
            ...
            <div class="bloque una-columna-centro-medio">
              <div class="titulo-bloque texto-izquierda">
                  <h2 class="icon-quill">Habilitar Proyecto</h2>
              </div>
              <br />
              <?php
              if($proyectos[0][0])
              ...
              {
                ?>
                <h3>No hay Proyectos Deshabilitadas!!!</h3>
                <?php
              }
              ?>
            </div>
    ...
    // se muestra un proyecto en especifico para luego ser habilitado 
