...
if($rsDatos!= null){
?>
<p class="titulo-ventana">SELECCIONE UNA EVIDENCIA</p>
<?php
...
while(!$rsDatos->EOF)
{
    ...
    <li class="lista-seleccionar" >
        ...
        <p id="texto" style="border:0px; margin: 0px; padding:0px;" onclick="enc_seleccionarTabla(this,'ENC_listaEvidencias_controlador.php','evidencia','#ventana-evidencias');"> <?php echo $rsDatos->fields[2].' '.(ucfirst(strtolower($rsDatos->fields[1])));?>
        </p> 
    </li>
    <?php
