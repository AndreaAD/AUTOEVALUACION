...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar Actividad", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        ///////////////////////////input hidden//////////////////////////////
        $datos=array(
                    "id"=>"pk_actividad", //(no necesario) define el id que tendra el campo
                    "name"=>"pk_actividad", // (necesario) define el name que tendra el campo
                    "value"=>$sqlRol->fields['pk_actividades']
        ...
        $datos=array(
                    ...
                    "selected"=>$sqlRol->fields['url']);// (necesario) El atributo value especifica el valor de un elemento
        ...
        $datos = array(
                    ...
                    "onchange"=>"FiltrarDato('../Controlador/SAD_Modificar_Actividad_Controlador.php', 'fk_sub_grupo');",                    
                    "selected"=>$sqlRol->fields['fk_grupos_actividades']
                    );
        ...
        /////////////////////////////////select con sql////////////////////////////////////////////////        
        $datos = array(
                    "id"=>"fk_sub_grupo",//(no necesario)el id que tendra el select
                    "name"=>"fk_sub_grupo",// (necesario) nombre que tendra el select
                    "label"=>"Sub Grupo",//(necesario - si se omite queda como si se pasara vacio)el nombre que se mostrara
                    "valor"=>"pk_sub_grupo_actividades",//(necesario)el valor que tendra cada elemento segun la consulta sql
                    "mostrar"=>"nombre",// (necesario)el valor a msotrar de cada elemnto segun la consulta sql
                    "obligatorio"=>"obligatorio_sub_grupo",
                    "selected"=>$sqlRol->fields['fk_sub_grupo_actividades']
                    );
                         
        $objComponentes->select_sql_sub_grupo ($sqlSubGrupo,$datos);
        ...
        $objComponentes->iconos($datos, $sqlRol->fields['icono']);
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosModulo('../Controlador/SAD_Modificar_Actividad_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
