...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Agregar Caracter&iacute;stica", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    $objComponentes->form($datos);
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidacionCaracteristica('../Controlador/CNA_Agregar_Caracteristica_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
