...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Modificar Sub Grupo", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    while(!$sqlRol->EOF){
        ...
        $datos=array(
                    ...
                    "value"=>$sqlRol->fields['pk_sub_grupo_actividades']
        ...
        $datos = array(
                    ...
                    "onchange"=>"FiltrarDato('../Controlador/SAD_Modificar_Sub_Grupo_Controlador.php', 'fk_grupo');",                    
                    "selected"=>$sqlRol->fields['fk_modulo']
                    );
                         
        $objComponentes->select_sql ($resModulo,$datos);
        ...
        $objComponentes->select_sql_sub_grupo($sqlGrupo,$datos);
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidarDatosSubGrupo('../Controlador/SAD_Modificar_Sub_Grupo_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
