...
$datos=array("tipo"=>"una-columna-centro-medio",// (necesario) tamaño del bloque puede ser {una-columna,una-columna-centro,una-columna-centro-medio}
            "titulo"=>"Agregar Evidencia", // (no necesario) titulo del bloque
...
$objComponentes->div_bloque_principal($datos);
    ...
    $objComponentes->form($datos);
        ...
        "placeholder"=>"Seleccione un caracter&iacute;stica"//(no necesario) El atributo placeholder especifica una pista corta que describe el valor esperado de un campo de entrada
        );
        ...
        $datos = array(
                    ...
                    "onclick"=>"ValidacionCaracteristica('../Controlador/CNA_Agregar_Evidencia_Controlador.php', this);"// (necesario) funcion js que se ejecutara si se hace click en el boton
                    );
