...
function modificar(){
    ...
    require_once('../Vista/CNA_Modificar_Aspecto_Vista.php');
}
...
function vista(){
    ...
    $strNombreBuscador = 'Modificar Aspecto';
    ...
    $strFuncion = "ValidarEstado('../Controlador/CNA_Modificar_Aspecto_Controlador.php', 'modificar');";
