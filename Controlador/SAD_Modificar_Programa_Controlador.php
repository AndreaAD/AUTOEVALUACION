...
function modificar(){
    ...
    require_once('../Vista/SAD_Modificar_Programa_Vista.php');
}
...
function vista(){
    ...
    $strNombreBuscador = 'Modificar Programa';
    ...
    $strFuncion = "ValidarEstado('../Controlador/SAD_Modificar_Programa_Controlador.php', 'modificar');";
