...
function modificar(){
    ...
    require_once('../Vista/SAD_Modificar_Modulo_Vista.php');
}
...
function vista(){
    ...
    $strNombreBuscador = 'Modificar M&oacute;dulo';
    ...
    $strFuncion = "ValidarEstado('../Controlador/SAD_Modificar_Modulo_Controlador.php', 'modificar');";
