...
function ver(){
    ...
    require_once('../Vista/SAD_Ver_Tipo_Usuario_Vista.php');
}
...
function vista(){
    ...
    $strNombreBuscador = 'Ver Tipo USuario';
    ...
    $strFuncion = "ValidarEstado('../Controlador/SAD_Ver_Tipo_Usuario_Controlador.php', 'ver');";
