...
if(isset($_REQUEST['T_Estado'])){
    switch($_REQUEST['T_Estado']){
        ...
        case 'modificar':{
            ...
            $sqlRol = $modelo->Ver_X_Tipo_Usuario($_POST);
...
function modificar(){
    ...
    require_once('../Vista/SAD_Modificar_Tipo_Usuario_Vista.php');
}
...
function vista(){
    ...
    $strNombreBuscador = 'Modificar Tipo Usuario';
    
    $strNombreHidden = 'pk_tipo_usuario';
    $strValorHidden = '0';
    ...
    $strFuncion = "ValidarEstado('../Controlador/SAD_Modificar_Tipo_Usuario_Controlador.php', 'modificar');";
