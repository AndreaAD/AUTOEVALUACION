...
function modificar(){
    ...
    require_once('../Vista/CNA_Modificar_Evidencia_Vista.php');
}
...
function vista(){
    ...
    $strNombreBuscador = 'Modificar Evidencia';
    ...
    $strFuncion = "ValidarEstado('../Controlador/CNA_Modificar_Evidencia_Controlador.php', 'modificar');";
